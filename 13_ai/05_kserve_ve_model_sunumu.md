...
HuggingFace üzerindeki hazır bir modeli doğrudan çekip API haline getirmek için KServe InferenceService nesnesi kullanılır.
...
Eğittiğiniz ve AWS S3 üzerine kaydettiğiniz bir model dosyasını sunmak için storageUri parametresiyle model dizini belirtilir.
