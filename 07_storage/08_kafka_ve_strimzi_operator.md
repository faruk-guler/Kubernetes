...
### A. KafkaNodePool (Rol ve Disk Havuzu)

Broker ve Controller rollerini birleştiren ve yüksek performanslı SSD PVC diski bağlayan havuz tanımı:
  ...
  storage:
    ...
    volumes:
      - id: 0
        ...
        size: 100Gi
        class: fast-ebs-sc # Hızlı SSD StorageClass
```

### B. Kafka (KRaft Küme Tanımı)

Node havuzunu bağlayan ve ZooKeeper'sız (KRaft) çalışan ana küme tanımı:
