...
kubectl cnpg backup postgres-production-cluster -n production
```
...
```yaml
# Yeni geri yüklenen kümede kurtarma hedefinin belirtilmesi (bootstrap):
spec:
  bootstrap:
    recovery:
      source: postgres-production-cluster # Kaynak küme adı
      recoveryTarget:
        targetTime: "2026-09-01 14:30:00.000000+00" # Kurtarılacak kesin zaman damgası
```
