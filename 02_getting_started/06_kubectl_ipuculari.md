...
Böylece `kubectl` ve operasyonel yönetim araçlarının temellerini tamamladık. Mimariyi inceledik, temel araç setimizi hazırladık ve küme yönetim dinamiklerini kavradık.

Artık kendi kodlarımızı ve uygulamalarımızı bu küme üzerinde yöneteceğimiz temel iş yükleri (Workloads), Pod yaşam döngüsü ve dağıtım stratejilerinin dünyasına odaklanmaya hazırız!
