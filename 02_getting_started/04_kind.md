...
> [!TIP]
> Bu yapılandırmayı ve Ingress hazır 1 Master + 2 Worker düğümlü Kind kümesini tek komutla kurmak için repodaki [`scripts/setup_local_lab.sh`](../scripts/setup_local_lab.sh) betiğini çalıştırabilirsiniz:
>
> ```bash
