...
Geliştirilen uygulamanın Git reposuna eklenen catalog-info.yaml dosyası Backstage tarafından taranarak yazılım kataloğuna dahil edilir.
...
metadata:
  ...
  description: Handles all internal payment transactions
  tags:
    - java
    - spring-boot
  annotations:
    github.com/project-slug: company/payment-processor
    backstage.io/kubernetes-label-selector: 'app=payment-processor'
spec:
  type: service
  lifecycle: production
  owner: group:finance-team
...
*(Detaylı entegrasyonlar için bkz: Crossplane)*
