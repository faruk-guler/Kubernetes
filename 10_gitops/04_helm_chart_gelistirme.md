...
description: Kurumsal Ödeme Servisi İçin Production Helm Paketi
type: application
version: 1.2.0        # Helm Chart sürümü (SemVer)
appVersion: "2.4.1"   # Konteyner uygulamasının gerçek sürümü
maintainers:
  - name: DevOps Team
...
image:
  ...
  tag: "" # Belirtilmezse Chart.appVersion kullanılır
