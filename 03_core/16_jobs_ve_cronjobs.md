...
Örnek bir senaryoda, her gün gece yarısı 00:00'da çalışan ve veritabanı yedeği alan CronJob tanımı şu şekilde kurgulanır:
      ...
      template:
        spec:
          ...
          - name: backup
            ...
            - /bin/sh
            - -c
            - "pg_dumpall -h pg-db -U admin > /backup/dump.sql && echo Backup Complete"
