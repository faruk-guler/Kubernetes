...
Peki bu kontrol düzlemi ve worker düğümleri üzerinde çalışan en temel yapı taşı nedir? Bir sonraki bölümde Kubernetes'in atomik iş yükü birimi olan Pod nesnesine ve temel bileşenlerine geçiyoruz.
