# Kubernetes Nedir ve Neden İhtiyaç Duyarız?

Monolitik mimarilerden mikroservis yapılarına ve bulut-yerel (cloud-native) mimariye geçiş, beraberinde büyük bir orkestrasyon zorluğu getirmiştir. Yüzlerce, belki binlerce konteynerin nerede çalıştığını, hangisinin çöktüğünü, nasıl haberleştiğini elle takip etmek imkânsızdır. Bu devasa problemleri çözmek için endüstri standardı haline gelen o "orkestra şefi" ile tanışma vakti: **Kubernetes**.
