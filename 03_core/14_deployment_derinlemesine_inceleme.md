...
Pod'lar doğası gereği ölümlüdür (ephemeral). Donanımsal bir arıza çıktığında veya sunucu yeniden başlatıldığında, o sunucu üzerinde tek başına koşan ("çıplak") bir pod kaybolur ve kendi kendine ayağa kalkamaz.
