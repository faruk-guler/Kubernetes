...
Uygulamaların sağlık kontrollerini (Probes) ve kesinti bütçelerini (PDB) yapılandırarak pod güvenliğini ve kararlılığını sağladık. Artık pod'ların dış dünyayla ve birbirleriyle nasıl iletişim kuracağını, trafik yönlendirmesini ve servis keşfini incelemeye hazırız.
