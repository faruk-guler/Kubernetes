...
> [!WARNING]
> HPA'nın doğru çalışabilmesi için pod tanımlarında `resources.requests` (kaynak istekleri) değerlerinin mutlaka belirlenmiş olması gerekir. Aksi takdirde yüzdesel hesaplama yapılamaz.
