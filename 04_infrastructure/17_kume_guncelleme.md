...
# Veya repodaki otomatik tarama betiğini çalıştırın:
bash ../scripts/audit_deprecated_apis.sh
...
> [!TIP]
> [`scripts/audit_deprecated_apis.sh`](../scripts/audit_deprecated_apis.sh) betiği, kümenizdeki tüm canlı Helm sürümlerini ve API nesnelerini tarayarak yeni Kubernetes sürümlerinde kaldırılacak API'leri tablo halinde listeler.
