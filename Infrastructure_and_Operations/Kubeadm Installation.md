...
## kubeadm, kubelet ve kubectl Kurulumu (Tüm Node'lar)
...
## Control Plane Başlatma (Yalnızca Master Node)
...
# Cilium veya Calico kurulunca Running olacaktır.
```
...
## Cluster Upgrade (Versiyon Yükseltme)
...
## Sertifika Yönetimi (Certificate Renewal)
