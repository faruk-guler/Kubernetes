...
spec:
  ...
  disruption:
    consolidationPolicy: WhenEmptyOrUnderutilized   # Boş veya az kullanılan node'ları birleştir
...
kubectl describe node worker-node-1 | grep -A5 "Conditions\|Allocatable"
```
